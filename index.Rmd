...
```{r}
confirmados.ordenado <- order(ca_covid19$confirmados, decreasing=FALSE)
...
```{r}
activos.ordenado <- order(ca_covid19$activos, decreasing=FALSE)
...
barplot(
  ...
  xlab="País", 
  ylab="Casos activos", 
  main="Casos activos de Covid-19 en países centroamericanos y DOM")
```

```{r}
fallecidos.ordenado <- order(ca_covid19$fallecidos, decreasing=FALSE)
...
barplot(
  ...
  main="Casos fallecidos de Covid-19 en países centroamericanos y DOM")
```
